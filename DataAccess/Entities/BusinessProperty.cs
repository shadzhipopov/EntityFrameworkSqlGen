...
namespace DataAccess.Entities
{
    public partial class BusinessProperty : DisplayNameObject
    {
        ...
        {
            this.MappedProperties= new HashSet<BusinessProperty>();
            this.MappingProperties = new HashSet<BusinessProperty>();
            this.ValidationExpressions = new HashSet<BusinessObjectExpression>();
        }
